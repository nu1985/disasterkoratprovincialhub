...
export const en = {
    ...
    assignments: {
        ...
        listTitle: "Resource Assignments",
        create: {
            title: "Create Assignment",
            description: "Dispatch a resource to an incident.",
    ...
    incidentDetail: {
        ...
        acknowledge: "Acknowledge & Process",
        ...
        by: "by",
        assignments: "Assignments",
        noAssignments: "No units assigned yet.",
...
export const th: Dictionary = {
    ...
    assignments: {
        title: "จัดการการมอบหมายงาน",
        listTitle: "รายการมอบหมายทรัพยากร",
        create: {
            title: "สร้างการมอบหมาย",
            description: "ส่งทรัพยากรไปยังสถานที่เกิดเหตุ",
            success: "สร้างการมอบหมายสำเร็จ",
    ...
    incidentDetail: {
        ...
        acknowledge: "รับทราบและดำเนินการ",
        resolve: "ทำเครื่องหมายว่าเสร็จสิ้น",
        cancel: "ยกเลิกเหตุการณ์",
        description: "รายละเอียด",
        noDescription: "ไม่มีรายละเอียดระบุไว้",
        type: "ประเภท",
        location: "สถานที่",
        reporterInfo: "ข้อมูลผู้แจ้ง",
        reporterName: "ชื่อผู้แจ้ง",
        phone: "เบอร์โทรศัพท์",
        timeline: "ไทม์ไลน์",
        statusChangedTo: "สถานะเปลี่ยนเป็น",
        by: "โดย",
        assignments: "การมอบหมายงาน",
        noAssignments: "ยังไม่มีการมอบหมายหน่วยงาน",
        manageAssignments: "จัดการการมอบหมาย",
        mapLocation: "ตำแหน่งบนแผนที่",
        unknownUnit: "ไม่ระบุหน่วยงาน",
    ...
    incidents: {
        ...
        table: {
            ...
            location: "สถานที่",
            status: "สถานะ",
            reportedAt: "เวลาที่แจ้ง",
            actions: "การจัดการ",
        },
        actions: {
            viewDetails: "ดูรายละเอียด",
            markAssigned: "ระบุว่ามอบหมายแล้ว",
            markInProgress: "ระบุว่ากำลังดำเนินการ",
            markDone: "ระบุว่าเสร็จสิ้น",
            markInvalid: "ระบุว่าไม่ถูกต้อง",
            updateStatus: "อัปเดตสถานะ",
        },
        statuses: {
            NEW: "แจ้งใหม่",
